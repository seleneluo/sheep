...
export const TRANSLATIONS: Record<Language, any> = {
  'en': {
    ...
    watchAdDesc: 'Watch an ad to clear the slot and continue playing',
    adLoading: 'Loading Ad...',
    adError: 'Ad failed to load. Please try again.',
    victory: 'VICTORY',
  ...
  'ja': {
    ...
    restart: '再開',
    watchAd: '広告を見て続ける',
    watchAdDesc: '広告を見るとスロットがクリアされ、ゲームを続けられます',
    adLoading: '広告を読み込み中...',
    adError: '広告の読み込みに失敗しました。もう一度お試しください。',
    victory: '勝利',
  ...
  'ko': {
    ...
    restart: '다시 시작',
    watchAd: '광고 시청 후 계속',
    watchAdDesc: '광고를 시청하면 슬롯이 비워지고 게임을 계속할 수 있습니다',
    adLoading: '광고 로딩 중...',
    adError: '광고 로드에 실패했습니다. 다시 시도해주세요.',
    victory: '승리',
    victoryDesc: '완벽합니다!',
    continue: '다음',
    difficultyNames: {
